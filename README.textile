...
Django is required. Outputs messages INFO-level and up to a file when Django's DEBUG setting is False. Outputs messages DEBUG-level and up to a file and the console when Django's DEBUG setting is True. 
