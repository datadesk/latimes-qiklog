...
A simplified version of Python's logging for a Django environment.

Debugging levels, log formatting and log output are preconfigured. Django is required. Outputs messages INFO-level and up to a file when DEBUG is True. Outputs messages DEBUG-level and up to a file and the console when DEBUG is False. 
...
<pre></code>
LOG_DIRECTORY = './whatever/logs/'</code></pre>
