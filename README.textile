...
Django is required. Outputs messages INFO-level and up to a file when DEBUG is True. Outputs messages DEBUG-level and up to a file and the console when DEBUG is False. 
